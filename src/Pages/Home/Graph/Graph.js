                ...
                <div className="container pagepadding">
                    <div className="row graphRow text-center text-white g-0">
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 graphData1">
                            ...
                            <p className='m-0 px-5 graphpadding'>Ages Of Passionate Players We Serve</p>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 graphData1">
                            ...
                            <p className='m-0 px-5'>Original Instruments And Gear Designs</p>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 graphData1">
                            ...
                            <p className='m-0 px-5'>Years Of Music And Sound Expertise</p>
                        </div>
                    </div>
                </div>
            </div>
